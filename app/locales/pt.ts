...
`,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Oferta de Lançamento do AI Assistant AI, desbloqueie o OpenAI o1, GPT-4o, Claude-3.5 e os mais recentes grandes modelos agora",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Usar AI Assistant AI",
        Label: "(A solução mais econômica)",
        SubTitle:
          "Mantido oficialmente pelo AI Assistant, pronto para uso sem configuração, suporta os mais recentes grandes modelos como OpenAI o1, GPT-4o e Claude-3.5",
