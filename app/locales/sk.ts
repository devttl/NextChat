...
const sk: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Uvítacia ponuka AI Assistant AI, okamžite odomknite OpenAI o1, GPT-4o, Claude-3.5 a najnovšie veľké modely",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Použite AI Assistant AI",
        Label: "(Najvýhodnejšie riešenie)",
        SubTitle:
          "Oficiálne udržiavané AI Assistant, pripravené na použitie bez konfigurácie, podporuje najnovšie veľké modely ako OpenAI o1, GPT-4o a Claude-3.5",
