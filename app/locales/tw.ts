...
const tw = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 AI Assistant AI 首發優惠，立刻解鎖 OpenAI o1, GPT-4o, Claude-3.5 等最新的大型語言模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "使用 AI Assistant AI",
        Label: "(性價比最高的方案)",
        SubTitle:
          "由 AI Assistant 官方維護，無須設定開箱即用，支援 OpenAI o1、GPT-4o、Claude-3.5 等最新的大型語言模型",
        ChatNow: "立刻開始對話",
      },
