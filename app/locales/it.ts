...
const it: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Offerta di lancio AI Assistant AI, sblocca OpenAI o1, GPT-4o, Claude-3.5 e i più recenti modelli di grandi dimensioni",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Usa AI Assistant AI",
        Label: "(La soluzione più conveniente)",
        SubTitle:
          "Mantenuto ufficialmente da AI Assistant, pronto all'uso senza configurazione, supporta i modelli più recenti come OpenAI o1, GPT-4o e Claude-3.5",
        ChatNow: "Chatta ora",
      },
